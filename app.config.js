const appConfig = {
  ...
  // app keywords
  keywords: 'bcwallet, metamask',
  // apollo client settings
  apollo: {
    // list of providers. if one of them is unavailable, another is randomly picked
    providers: [
      /*{
                http: 'https://xapi3.bcwallet.io/api',
                // for subscriptions
                ws: '',
            },*/
    ],
  ...
  chainId: '0xfa',
  // JSON-RPC endpoint
  rpc: 'https://rpcapi.bcwallet/',
  // used in links pointing to fantom explorer
  explorerUrl: 'https://e.bcwallet.io/',
  // used in links pointing to validators
  explorerUrl2: 'https://explorer.bcwallet.io/',
  ...
  testnet: {
    ...
    providers: [
      {
        http: 'https://xapi.testnet.bcwallet.io/api',
        // for subscriptions
        ws: '',
      },
    ],
    // JSON-RPC endpoint
    rpc: 'https://xapi.testnet.bcwallet.io/lachesis',
    // used in links pointing to fantom explorer
    explorerUrl: 'https://explorer.testnet.bcwallet.io/',
    // used in links pointing to validators
    explorerUrl2: 'https://explorer.testnet.bcwallet.io/',
    // used in links pointing to fantom explorer's transaction detail
