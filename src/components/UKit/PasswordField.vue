      ...
      <template #suffix="sProps">
        <slot name="suffix" v-bind="sProps">
          <span @click="onEyeButtonClick">
            <span v-if="dType === 'password'" class="btn same-size round small light" aria-hidden="true" tabindex="0">
              <icon data="@/assets/svg/eye-slash.svg" width="16" height="16" aria-hidden="true" />
            </span>
            <span v-if="dType === 'text'" class="btn same-size round small light" aria-hidden="true" tabindex="0">
