<template>
  <div>
    <div v-if="!isOpenedConfirmationPage" class="sign">
      <icon class="sign__logo" data="@/assets/svg/logo-wide.svg" alt="notifications" :original="true" />
      <p class="sign__description">
        I have an account.
        <router-link :to="{ name: 'sign-in' }" class="sign__description__link"> Login </router-link>
      </p>
      ...
      <form @submit.prevent="onSubmit">
        ...
        <button class="sign__submit" type="submit" :disabled="isFetchingSignup" @click="onSubmit">Register now</button>
        ...
        <p class="sign__privacy">
          By creating a wallet, you agree to the
          <router-link to="/" class="sign__privacy__link"> user agreement </router-link>
          and the company’s
          <router-link to="/" class="sign__privacy__link"> privacy policy </router-link>
        </p>
      </form>
    </div>
